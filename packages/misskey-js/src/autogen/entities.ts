...
export type AdminAntennasGlobalResponse = operations['admin___antennas___global']['responses']['200']['content']['application/json'];
...
export type AdminEmojiSuggestionsAcceptRequest = operations['admin___emoji-suggestions___accept']['requestBody']['content']['application/json'];
export type AdminEmojiSuggestionsAcceptResponse = operations['admin___emoji-suggestions___accept']['responses']['200']['content']['application/json'];
export type AdminEmojiSuggestionsListRequest = operations['admin___emoji-suggestions___list']['requestBody']['content']['application/json'];
export type AdminEmojiSuggestionsListResponse = operations['admin___emoji-suggestions___list']['responses']['200']['content']['application/json'];
export type AdminEmojiSuggestionsRejectRequest = operations['admin___emoji-suggestions___reject']['requestBody']['content']['application/json'];
...
export type DriveFilesGenerateAltTextRequest = operations['drive___files___generate-alt-text']['requestBody']['content']['application/json'];
export type DriveFilesGenerateAltTextResponse = operations['drive___files___generate-alt-text']['responses']['200']['content']['application/json'];
...
export type EmojiSuggestionsCancelRequest = operations['emoji-suggestions___cancel']['requestBody']['content']['application/json'];
export type EmojiSuggestionsCreateRequest = operations['emoji-suggestions___create']['requestBody']['content']['application/json'];
export type EmojiSuggestionsCreateResponse = operations['emoji-suggestions___create']['responses']['200']['content']['application/json'];
export type EmojiSuggestionsListRequest = operations['emoji-suggestions___list']['requestBody']['content']['application/json'];
export type EmojiSuggestionsListResponse = operations['emoji-suggestions___list']['responses']['200']['content']['application/json'];
export type EmojiListRemoteRequest = operations['emoji___list-remote']['requestBody']['content']['application/json'];
export type EmojiListRemoteResponse = operations['emoji___list-remote']['responses']['200']['content']['application/json'];
...
export type NotesRepliesBackfillResponse = operations['notes___replies___backfill']['responses']['200']['content']['application/json'];
...
export type TopPostsRequest = operations['top-posts']['requestBody']['content']['application/json'];
export type TopPostsResponse = operations['top-posts']['responses']['200']['content']['application/json'];
