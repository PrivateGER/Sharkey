...
export type AdminMrfPoliciesCreateRequest = operations['admin___mrf-policies___create']['requestBody']['content']['application/json'];
export type AdminMrfPoliciesCreateResponse = operations['admin___mrf-policies___create']['responses']['200']['content']['application/json'];
export type AdminMrfPoliciesDeleteRequest = operations['admin___mrf-policies___delete']['requestBody']['content']['application/json'];
export type AdminMrfPoliciesListResponse = operations['admin___mrf-policies___list']['responses']['200']['content']['application/json'];
export type AdminMrfPoliciesTestRequest = operations['admin___mrf-policies___test']['requestBody']['content']['application/json'];
export type AdminMrfPoliciesTestResponse = operations['admin___mrf-policies___test']['responses']['200']['content']['application/json'];
export type AdminMrfPoliciesUpdateRequest = operations['admin___mrf-policies___update']['requestBody']['content']['application/json'];
export type AdminMrfPoliciesUpdateResponse = operations['admin___mrf-policies___update']['responses']['200']['content']['application/json'];
