...
import type { CompressionLevel, UploaderFeatures, UploaderItem } from '@/use/use-uploader.js';
...
import { useUploader } from '@/use/use-uploader.js';
...
const uploader = useUploader({
	...
	nameConverter: props.nameConverter,
});
...
async function chooseFile() {
	const newFiles = await os.pickLocalFiles({ multiple: true });
