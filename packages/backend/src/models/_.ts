...
import { MiEmojiSuggestion } from '@/models/EmojiSuggestion.js';
...
export type EmojiSuggestionsRepository = Repository<MiEmojiSuggestion> & MiRepository<MiEmojiSuggestion>;
