				...
				messages: [
					{
						role: 'system',
						content: [
							{ type: 'text', content: 'Write detailed alt text for this image. Type out any text contained. Only return the alt text, no other text. Name characters if you recognize them.' },
